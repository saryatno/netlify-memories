...
const Post = ({ post, setCurrentId }) => {
    ...
    //console.log(user?.result?.sub === post?.creator || user?.result?._id === post?.creator);
    ...
    return (
        <Card className={classes.card}>
            ...
            <CardContent>
                <Typography variant='body2' color='textSecondary' component='p' gutterbuttom='true'>{post.message}</Typography>
            </CardContent>
